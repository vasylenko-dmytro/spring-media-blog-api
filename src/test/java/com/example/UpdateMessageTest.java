...
public class UpdateMessageTest {
    ...
    /**
     * Sending an http request to PATCH localhost:8080/messages/9999
     * (message id exists in db) and successful message text
     * <p>
     * Expected Response:
     * Status Code: 200
    ...
    public void updateMessageSuccessful() throws IOException, InterruptedException {
        ...
        assertEquals(1, (int) actualResult, "Expected to modify 1 row, but actually modified " + actualResult + " rows.");
    }
